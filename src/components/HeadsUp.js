...
const HeadsUp = () => {
    return (
        <div className="container expectations">
            <h3 style={{textAlign:'center'}}>Here's what you get from working with me</h3>

            <div className="attributes">
                <div className="attribute">
                    <img alt="" src="https://img.icons8.com/ios-filled/50/000000/available-updates.png"/>
                    <div className="info">
                ...
                <div className="attribute">
                    <img src="https://img.icons8.com/ios/50/000000/speed.png"/>
                    <div className="info">
                        <h5>Speed</h5>
                ...
                <div className="attribute">
                    <img src="https://img.icons8.com/ios-glyphs/30/000000/honesty.png"/>
                    <div className="info">
                        <h5>Honesty</h5>
                ...
                <div className="attribute">
                    <img src="https://img.icons8.com/dotty/80/000000/good-decision.png"/>
                    <div className="info">
                        <h5>Optimistic</h5>
